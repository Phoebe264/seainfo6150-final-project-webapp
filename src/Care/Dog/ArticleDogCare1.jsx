...
const ArticleDogCare1 = () => {
    return(
        <div className={styles.container}>
            <ul className={styles.ul}>
                <li>
                    <h1>Dog play: what’s the purpose?</h1>
                </li>
                <div><img className={styles.img} src='../images/dog1.jpg'/></div>
                <li>
                ...
                <li>
                    <h3>Why Is My Dog Eating Dirt? Possible Explanations</h3>
                </li>
                <li>
...
export default ArticleDogCare1